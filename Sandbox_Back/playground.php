    ...
    <div class="modal-content">
        <div class="modal-body">
            <form class="animated fadeIn">
                ...
                <div style="background-color:green; margin-top:7%" onclick="commitChanges()" class="goBtn"
                     id="commitBtn">
                    Go Ahead!
                </div>
            </form>
    ...
    <div class="modal-content" style="border-radius: 15px">
        ...
        <div class="modal-body">
            ...
            <form id="fileform" class="animated fadeIn">
                ...
                <!--                </fieldset>-->
                <fieldset style="    margin-top: 2%;">
                    <div style="float:right; background-color:green; margin-right: 5%" class="goBtn"
                         onclick="createFile(null, null)">Create
                    </div>
            ...
            <form id="folderform" style="display: none;" class="animated fadeIn">
                ...
                <fieldset style="    margin-top: 2%;">
                    <div style="float:right; background-color:green;margin-right: 5% " class="goBtn" ng-click="">
                        Create
                    </div>
                    <div style="float:left; background-color:#FF3366; margin-left:5%" class="goBtn"
                         onclick="document.getElementById('entryModal').style.display='none'">Cancel
...
<nav class="navbar-default" style="background:url('../images/blur.jpg');background-size: cover">
    <div class="container-fluid">
        <div class="navbar-header" style="width: 80%">
            ...
            <button title="Choose Repo" onclick="chooseRepo()" class="btn navbar-btn toolbarButton"><i
            ...
            <button title="Run" value="" id="runButton" class="btn navbar-btn toolbarButton" onclick="compile()"
                    ng-if="isRepoOpen"><i class="fas fa-play fa-2x"></i>
            </button>
            <div class="btn-group-toggle" data-toggle="buttons" style="position:absolute;left:44%;">
                <label class="btn btn-default" onclick="toggleDisplayBtn('left'); updateDisplay()">
                    <input onchange="updateDisplay()" type="checkbox" checked autocomplete="off" id="left"><span
                            class="fas fa-angle-double-left"></span>
                </label>
                <label class="btn btn-default" onclick="toggleDisplayBtn('mid'); updateDisplay()">
                    <input type="checkbox" checked onchange="updateDisplay()" autocomplete="off" id="mid"><span
                            class="fas fa-angle-double-up"></span>
                </label>
                <label class="btn btn-default" onclick="toggleDisplayBtn('right'); updateDisplay()">
                    <input type="checkbox" checked autocomplete="off" onchange="updateDisplay()" id="right"><span
	...
	margin-right: 0%;">
            <button class="rightButton"><span id="livePreviewRestartBtn" class="fas fa-sync"
                                              onclick="resetLivePreview()"></span></button>
            <button class="rightButton" onclick="openNoteNav()" id="addpeople"><span class="fas fa-sticky-note"></span>
            </button>
        </div>
    </div>
</nav>
...
<div id="leftcol" class='animated zoomIn' ng-if="isRepoOpen">
    ...
    <?php //echo $text["downloadFolder"]; ?><!--</li>-->
...
<iframe class="rightcol animated zoomIn" style="float:right;" id="rightcol" srcdoc="{{livePreview}}"
