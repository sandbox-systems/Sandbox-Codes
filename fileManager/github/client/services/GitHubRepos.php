...
class GitHubRepos extends GitHubService {
    ...
    public function listYourRepositories($type = null, $sort = null, $direction = null) {
        ...
        return $this->client->request("/user/repos?per_page=100", 'GET', $data, 200, 'GitHubSimpleRepo', true);
    }
     ...
     */
    public function create($owner = null, $repo, $private, $has_issues = null, $has_wiki = null, $has_downloads = null, $default_branch = null, $description = null, $homepage = null, $team_id = null, $auto_init = null, $gitignore_template = null, $license_template = null) {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'Sandbox');
